    ...
    <div className="bg-[#f7faf7] min-h-full flex flex-col font-manrope">
      ...
      <main className="flex-grow pt-6 pb-24 px-4 w-full mx-auto relative z-10">
        ...
        <section className="mb-8 w-full max-w-sm mx-auto">
          ...
          <div className="flex justify-between items-center mt-2 px-2">
             ...
             <span className="text-[10px] text-[#6e7975]">Inventory</span>
        ...
        <section className="bg-white p-5 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-[#e0e3e0]">
          <div className="mb-6">
            <h2 className="text-[24px] font-bold text-[#005344] mb-1">Business Profile</h2>
            <p className="text-[14px] text-[#3e4945]">Tell us about your shop to help us customize your experience.</p>
          </div>

          <form className="flex flex-col gap-5">
            {/* Shop Name */}
            <div className="space-y-1.5">
              <label className="text-[14px] font-semibold text-[#3e4945]">Shop Name</label>
              <input className="w-full h-12 px-4 bg-[#F3F4F6] border border-[#bec9c4] rounded-lg focus:ring-2 focus:ring-[#005344] outline-none text-[16px]" placeholder="e.g., Al-Madina Superstore" type="text" />
            </div>

            {/* Business Type */}
            <div className="space-y-1.5">
              <label className="text-[14px] font-semibold text-[#3e4945]">Business Type</label>
            ...
            {/* Shop Size */}
            <div className="space-y-1.5">
              <label className="text-[14px] font-semibold text-[#3e4945]">Shop Size (Sq Ft)</label>
              <input className="w-full h-12 px-4 bg-[#F3F4F6] border border-[#bec9c4] rounded-lg focus:ring-2 focus:ring-[#005344] outline-none text-[16px]" placeholder="e.g., 500" type="number" />
            </div>

            {/* Daily Average Footfall */}
            <div className="space-y-1.5">
              <label className="text-[14px] font-semibold text-[#3e4945]">Daily Average Footfall</label>
              <div className="relative">
                <select className="w-full h-12 px-4 bg-[#F3F4F6] border border-[#bec9c4] rounded-lg focus:ring-2 focus:ring-[#005344] outline-none text-[16px] appearance-none cursor-pointer">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[14px] font-semibold text-[#3e4945]">Opening Time</label>
                <input className="w-full h-12 px-4 bg-[#F3F4F6] border border-[#bec9c4] rounded-lg focus:ring-2 focus:ring-[#005344] outline-none text-[16px]" type="time" defaultValue="09:00" />
              </div>
              <div className="space-y-1.5">
                <label className="text-[14px] font-semibold text-[#3e4945]">Closing Time</label>
                <input className="w-full h-12 px-4 bg-[#F3F4F6] border border-[#bec9c4] rounded-lg focus:ring-2 focus:ring-[#005344] outline-none text-[16px]" type="time" defaultValue="22:00" />
              </div>
            </div>

            {/* Categories of Products Sold */}
            <div className="space-y-2 mt-2">
              <label className="text-[14px] font-semibold text-[#3e4945] block">Categories of Products Sold</label>
              <div className="grid grid-cols-2 gap-3">
                {['Grocery', 'Dairy', 'Beverages', 'Cosmetics', 'Stationary', 'Household'].map((cat, i) => (
                  <label key={cat} className="flex items-center gap-2 p-3 border border-[#bec9c4] rounded-lg cursor-pointer hover:bg-[#ebefec] transition-colors">
                    <input defaultChecked={i < 2} className="w-4 h-4 rounded border-[#bec9c4] text-[#005344] focus:ring-[#005344]" type="checkbox" />
      ...
      <footer className="sticky bottom-0 w-full z-50 bg-[#f7faf7] border-t border-[#bec9c4] shadow-[0_-4px_20px_rgba(0,0,0,0.05)] mt-auto">
        <div className="flex justify-between items-center px-4 py-4">
          ...
          {/* Next Button */}
          <button onClick={() => navigate('/onboarding/merchant/step3')} className="flex items-center justify-center bg-[#005344] text-white rounded-lg px-8 py-3 hover:opacity-90 transition-all shadow-md active:scale-95">
