    ...
    <div className="bg-surface-container-low min-h-full flex flex-col font-manrope">
      ...
      <main className="flex-grow pt-6 pb-24 px-4 w-full mx-auto relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input className="w-full bg-[#F3F4F6] border border-[#bec9c4] rounded-lg p-3 focus:ring-2 focus:ring-[#005344] focus:border-[#005344] transition-all text-[16px] outline-none appearance-none" type="date" />
            ...
            {/* Father/Husband Name */}
            <div className="space-y-1.5">
              <label className="text-[14px] font-semibold text-[#3e4945]">Father's / Husband's Name</label>
              <input className="w-full bg-[#F3F4F6] border border-[#bec9c4] rounded-lg p-3 focus:ring-2 focus:ring-[#005344] focus:border-[#005344] transition-all text-[16px] outline-none" placeholder="Enter father's or husband's name" type="text" />
            </div>
        ...
        <div className="flex items-start gap-2 px-1 opacity-70 mb-4">
          ...
          <p className="text-[12px] text-[#3e4945]">Your data is encrypted and stored securely according to Pakistani retail security standards.</p>
        </div>
      </main>
      ...
      <nav className="sticky bottom-0 w-full z-50 flex justify-between items-center px-6 py-4 bg-[#f7faf7] border-t border-[#bec9c4] shadow-[0_-4px_20px_rgba(0,0,0,0.05)] mt-auto">
        ...
        {/* Next Button */}
        <button onClick={() => navigate('/onboarding/merchant/step2')} className="flex items-center justify-center gap-1 bg-[#fe6a34] text-[#5d1900] rounded-lg px-8 py-3 hover:bg-[#ffdbd0] transition-all active:scale-95 shadow-md font-bold">
